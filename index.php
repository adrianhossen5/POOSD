...
<body>
    ...
    <div class="container">
        <h2 style="text-align: center; color: #5D5B5A;">Login-Up</h2>
        <!-- // add post request here -->
        <form class="login-form" action="your_login_endpoint.php" method="post" style="max-width: 400px; margin: 0 auto; padding: 20px; border: 1px solid #ccc; border-radius: 5px;">
            ...
            <div class="button-container" style="text-align: center;">
                <button class="add-button">Sign-in</button>
            </div>
        </form>
        <div class="button-container">
            <button class="add-button" onclick="location.href='signup.php'" type="button">
                Sign-up
            </button>
        </div>
    </div>
